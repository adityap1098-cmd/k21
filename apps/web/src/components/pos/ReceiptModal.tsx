...
export function ReceiptModal({ isOpen, receiptData, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="bg-surface-raised rounded-xl shadow-xl w-full max-w-sm mx-4">
        {/* Header */}
        <div className="p-6 text-center border-b">
          ...
          <h2 className="text-xl font-semibold text-ink">Transaksi Selesai</h2>
        </div>

        {/* Summary */}
        <div className="p-4 space-y-2 border-b">
          <div className="flex justify-between text-sm">
            <span className="text-ink-muted">ID Transaksi</span>
        ...
        <div className="p-4 space-y-3">
          ...
          <button
            onClick={handlePrint}
            disabled={isPrinting}
            className="w-full flex items-center justify-center gap-2 border border-border rounded-lg py-2.5 text-sm font-medium hover:bg-surface disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-success text-white rounded-lg py-2.5 text-sm font-medium hover:bg-success"
          >
          ...
          <button
            onClick={onClose}
            className="w-full bg-brand text-white rounded-lg py-2.5 text-sm font-semibold hover:bg-brand-hover"
          >
            Transaksi Baru
          </button>
